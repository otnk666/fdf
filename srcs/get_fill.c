...
/*   Updated: 2025/05/08 20:53:34 by skomatsu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void process_line(char **nums, t_map *data, int row)
{
    ...
    {
        parse_point(num[i],&data->points[row][i]);
        i++;
    }
}

void free_resouces(char **array, char *ptr)
{
    int i;
